...
if menu == "CV":
    ...
    # ---------------- Expériences ----------------
        ...
        - Développement de tableaux de bord interactifs dans Power BI pour suivre la progression du déploiement de la fibre optique.
        - Automatisation des rapports hebdomadaires pour les clients tels qu'Orange et Bouygues Télécom, permettant ungain de temps de 20 % dans la production de livrables.
        - Collaboration avec des équipes techniques pour analyser et optimiser les indicateurs clés de performance (KPI).       
